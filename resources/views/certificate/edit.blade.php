        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('paymentList', ['eventId' => $registration->event_id])}}">Daftar Peserta</a></li>
            ...
            <div class="card-body p-3">
                <form action="{{ route('updateCertificate', ['certificate' => $certificate->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="certificateNow">Sertifikat Sekarang</label>
                        <div>
                            <img src="{{ asset('img/certificate/' . $certificate->certificate_url) }}" style="width: 500px; height: auto;">
                        </div>
                        <div class="mt-4">
                            <label for="txtCertificate">Edit Sertifikat</label>
                        </div>
